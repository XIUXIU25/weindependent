...
function ProfilePage ({ profile, setProfile }) {
  ...
  //TODO: In future this fuction will be seperatly in a function or hook
  // Firstly check if logged in
  useEffect(() => {
    ...
    if (token) {
      ...
      setProfile({
        ...
        actualName: 'Default Name',
        profilePic: "we-in-dependent-frontend/src/assets/profile-icon.svg",
        isCarFree: false,
      })

      //TODO: In future we use database to get user data
      /*
      axios.get('http://localhost:5000/api/profile', {
        ...
        .catch((error) => {
          message.error('Failed to fetch profile: ' + error.response?.data?.message || error.message);
        });
      */
    } else {
      // Not logged in
